...
const PlayIcon = () => (
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 mr-1.5">
    ...
    <path d="M23.498 12a1 1 0 0 1-.016.177c-.05.25-.2.484-.42.674l-18 14a1 1 0 0 1-1.562-.82V3.969a1 1 0 0 1 1.562-.82l18 14a1 1 0 0 1 .436.667A1 1 0 0 1 23.498 12z"/>
                ...
                <div ref={carouselRef} className="relative mt-10 w-full max-w-6xl mx-auto overflow-x-auto flex gap-5 cursor-grab active:cursor-grabbing select-none" onMouseEnter={() => { 
                    ...
                    {[...projectsList, ...projectsList].map((i, index) => (
                        ...
                        <>
                            ...
                            <div key={index} className="flex-shrink-0 border border-dashed border-black dark:border-white w-72 bg-white dark:bg-gray-900 rounded-md shadow-md hover:shadow-lg transition-transform duration-300 hover:scale-105 overflow-hidden">
                                ...
                                <div className="relative overflow-hidden rounded-t-xl">
                                    ...
                                    <div className="flex flex-col items-center gap-2">
                                        ...
                                        <div className='flex flex-row items-center justify-between gap-x-3'>
                                            ...
                                            <a href={i.projectDemoLink} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center text-white font-medium px-3 py-1.5 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500 transition-all duration-300 hover:scale-105 hover:from-indigo-600 hover:to-purple-600 text-sm">
