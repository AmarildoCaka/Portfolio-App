...
const DarkThemeImgComp = () => {
    ...
    const darkThemeImg = <svg xmlns="http://www.w3.org/2000/svg" width="54" height="48" viewBox="0 0 64 48" fill="none">
    ...
    return (
        ...
        <>
            ...
            <div id={darkThemeBoxId} className="light-theme-box flex flex-col justify-col place-items-center text-center p-5">
