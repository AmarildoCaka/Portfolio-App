...
const SystemThemeImgComp = () => {
    ...
    const systemThemeImg = <svg xmlns="http://www.w3.org/2000/svg" width="64" height="48" viewBox="0 0 64 48" fill="none">
    ...
    return (
        ...
        <div id={systemThemeBoxId} className="light-theme-box flex flex-col justify-col place-items-center text-center p-5">
